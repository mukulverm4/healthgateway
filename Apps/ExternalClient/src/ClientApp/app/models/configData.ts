...
export class ExternalConfiguration {
  ...
  // Gets or sets the Health Gateway Externalclient specific configuration.
  public externalClient!: ExternalClientConfiguration;
...
export class ExternalClientConfiguration {
...
// Various timeout values used by the VUE ExternalClient application.
export class TimeOutsConfiguration {
  // Gets or sets the idle time in seconds that the Externalclient will use before it automatically logs the user out.
  public idle!: number;
