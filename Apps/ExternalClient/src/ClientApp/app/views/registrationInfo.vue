  ...
  <b-container>
    <b-row class="pt-5">
      ...
      <b-container class="register-with-bc-card">
        ...
        <b-row>
          <b-col fluid>
            <img width="350" src="@/assets/images/landing/002_Devices.png"
          /></b-col>
            ...
            >
              <b-row class="m-5">
                <b-col>
                  <b-row>
                    <b-col>
                      <span class="align-top bullet rounded-circle py-1 px-2"
                        >1</span
                      >
                      <img
                        class="image-step"
                  ...
                  <b-row>
                    <b-col>
                      <span class="pl-4">Grab your card</span>
                    </b-col>
                  </b-row>
                </b-col>
                <b-col>
                ...
                <b-col>
                  <b-row>
                    <b-col>
                      ...
                      <b-row>
                        <b-col>
                          <span class="pl-4">Follow instructions in-app</span>
                        </b-col>
                      </b-row>
                      <b-row>
                        <b-col>
                          <span class="pl-4">to set up your mobile card</span>
                        </b-col>
                      </b-row>
                    </b-col>
                  </b-row>
        ...
        <b-row class="mb-5">
          <b-col>
            ...
            <b-collapse id="collapse-4" v-model="dongleVisible" class="mt-2">
              <div class="m-5 px-4">
                <b-row>
                  <b-col>
                    <img
                ...
                <b-row>
                  <b-col
                    >If you are using a computer with a USB port, you can choose
                    to use a goverment issued USB card reader. The USB card
                    reader will read the chip embedded in your BC Services Card
                    to identify you when you log in.</b-col
                  >
                </b-row>
                <b-row>
                  <b-col
                    ><a
                      ...
                      >Learn more about using your BC Services Card</a
                    ></b-col
                  >
                </b-row>
              </div>
...
import { ExternalClientConfiguration } from "@/models/configData";
...
export default class RegistrationInfoComponent extends Vue {
  ...
  @Prop() email?: string;
  @Getter("externalClient", { namespace: "config" })
  externalClientConfig: ExternalClientConfiguration;

  mounted() {
    this.isRegistrationInviteOnly =
      this.externalClientConfig.registrationStatus == RegistrationStatus.InviteOnly;
    this.isRegistrationClosed =
      this.externalClientConfig.registrationStatus == RegistrationStatus.Closed;
